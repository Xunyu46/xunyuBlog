...
![](assets/d4bdafdec18348049f9c92bf8378edb8~tplv-k3u1fbpfcp-zoom-1.image)
...
![](assets/7417c9dd01f64ce59ed039c25b738bfc~tplv-k3u1fbpfcp-zoom-1.image)

我在应用代码中调用了`debounce`方法，这个方法会依赖很多工具函数，如下图所示:

![image.png](assets/45a12c84cbc04e19a897b5b9dbbac355~tplv-k3u1fbpfcp-watermark.image)
...
![](assets/8ebf8a1305fd4dfa88f5ad15c5c936fb~tplv-k3u1fbpfcp-zoom-1.image)
...
![image.png](assets/b9aec2d8edbb4ed0bf88497aab7dcffc~tplv-k3u1fbpfcp-watermark.image)

同时，在项目启动成功后，你可以在根目录下的`node_modules`中发现`.vite`目录，这就是预构建产物文件存放的目录，内容如下:

![image.png](assets/f96e0f50748a4efb9cb227d45ffcec5d~tplv-k3u1fbpfcp-watermark.image)
...
![image.png](assets/dec47fc8960041d296965d9fca660645~tplv-k3u1fbpfcp-watermark.image)
...
![image.png](assets/595857912ca34a2d8ad45086313209e5~tplv-k3u1fbpfcp-watermark.image)
...
![image.png](assets/e72fecff62ec477686aeb539ee66aa4e~tplv-k3u1fbpfcp-watermark.image)
...
![image.png](assets/c20f1531d19f40d197b18e1949523829~tplv-k3u1fbpfcp-watermark.image)
