...
export function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (
    _openBlock(),
    _createBlock(_component_ChildComponent, null, {
      header: _withCtx(() => [_createTextVNode('header')]),
      content: _withCtx(() => [_createTextVNode('content')]),
...
export function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (
    _openBlock(),
    _createBlock(
      _component_child_component,
      null,
      {
        [_ctx.dynamicSlotName]: _withCtx(() => [_createTextVNode('header')]),
        _: 2 /* DYNAMIC */,
      },
      1024 /* DYNAMIC_SLOTS */,
    )
