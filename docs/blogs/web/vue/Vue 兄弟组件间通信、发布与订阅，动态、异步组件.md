...
<template>
  <div class="container">
    <div class="tab-title">
      <button @click="currentTab = 'Tab1'" :class="{ active: currentTab === 'Tab1' }">Tab1</button>
      <button @click="currentTab = 'Tab2'" :class="{ active: currentTab === 'Tab2' }">Tab2</button>
      <button @click="currentTab = 'Tab3'" :class="{ active: currentTab === 'Tab3' }">Tab3</button>
    </div>
...
<script>
  import { defineAsyncComponent } from 'vue'
  // 定义异步组件
  const AsyncCompA = defineAsyncComponent(() => import('./components/AsyncCompA.vue'))

  const AsyncCompB = defineAsyncComponent(() => import('./components/AsyncCompB.vue'))
