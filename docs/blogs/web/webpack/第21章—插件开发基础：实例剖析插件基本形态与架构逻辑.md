...
![image.png](assets/407f8596a5b24203b091a51b5fca6726~tplv-k3u1fbpfcp-watermark.image)
...
![image.png](assets/08c337e97f664f3da4d301a3a5404f7d~tplv-k3u1fbpfcp-watermark.image)
  ...
  async run(compiler, options, wanted, exclude) {
    compiler.hooks.compilation.tap(this.key, (compilation) => {
      ...
      compilation.hooks.succeedModule.tap(this.key, ({ resource }) => {
        // 判断是否需要检查该文件
        if (isMatch(file, wanted, { dot: true }) && !isMatch(file, exclude, { dot: true })) {
          lint(file)
        }
      })
...
![image.png](assets/3ad70295b2214f3ebb77b9024d41ae1f~tplv-k3u1fbpfcp-watermark.image)
...
![image.png](assets/4eaa247a0d034d6dbcc4a5624573311c~tplv-k3u1fbpfcp-watermark.image)
