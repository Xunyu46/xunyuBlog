...
![image.png](assets/bd205317bb034096b726ae02f0752348~tplv-k3u1fbpfcp-watermark.image)
...
![image.png](assets/21347644521b418397c1454b05924f18~tplv-k3u1fbpfcp-watermark.image)
...
![image.png](assets/552fd8ddf01649a49f693f12ba297d8f~tplv-k3u1fbpfcp-watermark.image)

构建后将生成入口 `index.js` 与异步模块 `async-a.js` 两个 Chunk 对应的产物：

![image.png](assets/e89cf6a8abff4380954e219006e611a3~tplv-k3u1fbpfcp-watermark.image)
...
![image.png](assets/412eb1f1e36f40b39dfe9d13bd7e5b39~tplv-k3u1fbpfcp-watermark.image)

父级 Chunk\(`index`\)也受到了影响，生成新的 Hash 值，这是因为在 `index` 中需要记录异步 Chunk 的真实路径：

![image.png](assets/bd2ef56310024c05a2f9174e837d4f53~tplv-k3u1fbpfcp-watermark.image)
...
![image.png](assets/17895ee7fd4649e3b0f86e523ede7d36~tplv-k3u1fbpfcp-watermark.image)
...
![image.png](assets/96a16f771ffd4377ac8a8a2cefada387~tplv-k3u1fbpfcp-watermark.image)
...
![6e31845d-7b51-422d-8822-83126c613d7b.gif](assets/60e56f7cdd6f4d869094275e86e5467b~tplv-k3u1fbpfcp-watermark.image)
...
![image.png](assets/f7a142bb02ea4615b3cb5e3bb73a9da4~tplv-k3u1fbpfcp-watermark.image)
