...
![image.png](assets/faa5b4982c6d49679099edf11967ae29~tplv-k3u1fbpfcp-watermark.image)

点击页面中的 `modules/chunks/assets` 按钮，页面会渲染出对应实体的依赖关系图，例如：

![image.png](assets/9b28a6b379e24edfabcbd1e9d3567b56~tplv-k3u1fbpfcp-watermark.image)

除 `modules/chunks/assets` 外，右上方菜单栏 **Hints** 还可以查看构建过程各阶段、各模块的处理耗时，可以用于对比分析各个阶段的性能情况：

![image.png](assets/3af3b249f4d64133ace6893bdadd5a8c~tplv-k3u1fbpfcp-watermark.image)
...
![image.png](assets/f2d2eae9a84c4dad9af99532c82046aa~tplv-k3u1fbpfcp-watermark.image)
...
![image.png](assets/89229aa5d14e4abe8c07e2866fd7e6d1~tplv-k3u1fbpfcp-watermark.image)
...
![image.png](assets/9e303d6c4fc14656bfb4d385479c2900~tplv-k3u1fbpfcp-watermark.image)
...
![image.png](assets/0df8d57ed3144d688f42d30a028fc1ad~tplv-k3u1fbpfcp-watermark.image)
...
![image.png](assets/db6aca635d2048768123e27b79647896~tplv-k3u1fbpfcp-watermark.image)
...
![image.png](assets/b1deeb71f04745b1ac71d05b5490f2b9~tplv-k3u1fbpfcp-watermark.image)
...
![image.png](assets/f342a98ef19e42e8ab756891b814d942~tplv-k3u1fbpfcp-watermark.image)
