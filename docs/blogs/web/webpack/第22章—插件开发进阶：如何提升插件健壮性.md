...
![image.png](assets/1035c8f81506496f90535eb366d762a1~tplv-k3u1fbpfcp-watermark.image)
...
![3f291b39-e4cd-498c-b1e8-819d964982ab.gif](assets/3416427756ea48048cddcaf9aa7cbcdc~tplv-k3u1fbpfcp-watermark.image)
  ...
  it('should inject foo banner', async () => {
    ...
    await Promise.all(
      Object.keys(assets).map(async (name) => {
        ...
        const result = await promisify(compiler.outputFileSystem.readFile)(pathToEmitted, {
          encoding: 'UTF-8',
        })
