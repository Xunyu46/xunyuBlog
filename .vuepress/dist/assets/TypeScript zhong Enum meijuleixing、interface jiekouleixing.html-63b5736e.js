import{_ as t,r as o,o as c,c as i,a as s,b as n,e as p,d as a}from"./app-7ac1ad86.js";const l={},u=a(`<h1 id="typescript-中-enum-枚举类型、interface-接口类型" tabindex="-1"><a class="header-anchor" href="#typescript-中-enum-枚举类型、interface-接口类型" aria-hidden="true">#</a> TypeScript 中 Enum 枚举类型、interface 接口类型</h1><p>TIP</p><p>从本节正式开始学习 Enum 枚举类型、interface 接口类型的核心基础 和 应用实践。</p><ul><li>Enum 枚举类型</li><li>interface 接口类型</li></ul><h2 id="一、枚举类型" tabindex="-1"><a class="header-anchor" href="#一、枚举类型" aria-hidden="true">#</a> 一、枚举类型</h2><p>TIP</p><p>观察以下代码，这是一个角色判断的案例：一般系统都会有很多种角色，每个角色都会有不同的操作权限，同时也会对应不同的 UI 界面。</p><blockquote><p>一般用户登录系统时，会做一些初始化的工作，如下代码所示</p></blockquote><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 初始化角色权限</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-1、自定义枚举的初始值" tabindex="-1"><a class="header-anchor" href="#_2-1、自定义枚举的初始值" aria-hidden="true">#</a> 2.1、自定义枚举的初始值</h3><p>TIP</p><p>枚举可定义初始值，给第一个枚举成员设置初始值，后边的枚举成员会在此基础上依次递增</p><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token comment">// 数字枚举</span>
<span class="token keyword">enum</span> Role <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>枚举在运行环境下，被编译成了一个对象，除了正常的枚举成员之外还多了一些其他成员。</p><p><img src="https://www.arryblog.com/assets/img/image-20230621135946497.956e9b12.png" alt="image-20230621135946497"></p><p>注：</p><p>这时，如果我们需要获取枚举成员的值即可通过枚举成员的名称来索引，还可以通过值来索引。</p><h3 id="_2-2、枚举的实现原理" tabindex="-1"><a class="header-anchor" href="#_2-2、枚举的实现原理" aria-hidden="true">#</a> 2.2、枚举的实现原理</h3><p>TIP</p>`,36),r={href:"https://www.typescriptlang.org/play?#code/PTAEgdTR1bULPND45AoApgOwK4FtQCUD2AbRUAb3lDNBFECvAwLO1BJOSjkBC3QXCVBpzUB4FQLjlQBGQGH-AG3mAS6MBzcgAZAAPptS5AMqoADogBOAQQAm6AJbJtAZwAuKgIaGcK0AF4+AGlllNOvUdPmV+++VAB5FRt0TFQBPJ10DYzMLL3IAVX1VGLIAEUQAN0Q8HGUVeABfIA",target:"_blank",rel:"noopener noreferrer"},d=a(`<p><img src="https://www.arryblog.com/assets/img/image-20230621140523758.73e9982a.png" alt="image-20230621140523758"></p><p>注：</p><p>查看编译后的 JS 代码可以看到</p><p>枚举被编译成了一个对象，枚举成员的名称被作为 key ，枚举成员的值被作为了 value，这个表达式直接返回了 value 。然后 value 又被作为了 key，成员的名称又被作为了 value。</p><blockquote><p>这种方法叫做：反向映射，这就是枚举的实现原理。</p></blockquote><h3 id="_3、enum-结构的特别之处" tabindex="-1"><a class="header-anchor" href="#_3、enum-结构的特别之处" aria-hidden="true">#</a> 3、Enum 结构的特别之处</h3><p>TIP</p><p>Enum 结构的特别之处在于，它既是一种类型，也是一个值。</p><p>绝大多数 TypeScript 语法都是类型语法，编译后会全部去除，但是 Enum 结构是一个值，编译后会变成 JavaScript 对象，留在代码中。</p><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token comment">// 编译前</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4、enum-应用场景" tabindex="-1"><a class="header-anchor" href="#_4、enum-应用场景" aria-hidden="true">#</a> 4、Enum 应用场景</h3><p>TIP</p><p>由于 TypeScript 的定位是 JavaScript 语言的类型增强，所以官方建议谨慎使用 Enum 结构，因为它不仅仅是类型，还会为编译后的代码加入一个对象。</p><p>Enum 结构比较适合的场景是，成员的值不重要，名字更重要，从而增加代码的可读性和可维护性。</p><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token keyword">enum</span> Operator <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_8、字符串枚举" tabindex="-1"><a class="header-anchor" href="#_8、字符串枚举" aria-hidden="true">#</a> 8、字符串枚举</h3><p>TIP</p><p>Enum 成员的值除了设为数值，还可以设为字符串。也就是说，Enum 也可以用作一组相关字符串的集合。</p><blockquote><p>枚举成员的值是 字符串，它就是字符串枚举</p></blockquote><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token comment">// 字符串枚举</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,41),m={href:"https://www.typescriptlang.org/play?#code/PTAEnVtQyb0JjlCzzQ+OQFAFMB2BXAtqAssgzvgIYDmyoA3oqDaAMroDGjB+oAvKAOSAIRoPlKXADTVaAMSIBLADYdugRk1ApLFdEAX0RA",target:"_blank",rel:"noopener noreferrer"},b=a(`<p><img src="https://www.arryblog.com/assets/img/image-20230621173447355.eeab66fb.png" alt="image-20230621173447355"></p><p>注：</p><p>从以上编译后的 JS 可以看出，只有枚举成员的名称被作为了 key ，就是说字符串枚举是不可以进行反向映射的。</p><h3 id="_8-1、字符串枚举-注意事项" tabindex="-1"><a class="header-anchor" href="#_8-1、字符串枚举-注意事项" aria-hidden="true">#</a> 8.1、字符串枚举 - 注意事项</h3><p>TIP</p><p>字符串枚举的所有成员值，都必须显式设置。</p><p>如果没有设置，成员值默认为数值，且位置必须在字符串成员之前。</p><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token keyword">enum</span> Foo <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_9、keyof-运算符" tabindex="-1"><a class="header-anchor" href="#_9、keyof-运算符" aria-hidden="true">#</a> 9、keyof 运算符</h3><p>TIP</p><p>keyof 运算符可以取出 Enum 结构的所有成员名，作为联合类型返回。</p><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token keyword">enum</span> MyEnum <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_10、异构枚举" tabindex="-1"><a class="header-anchor" href="#_10、异构枚举" aria-hidden="true">#</a> 10、异构枚举</h3><p>TIP</p><p>数字枚举 和 字符串枚举 混用，就构成了 异构枚举。</p><blockquote><p>当然，这种情况容易引起混淆。因此不建议使用 ！</p></blockquote><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token comment">// 异构枚举</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_11、枚举成员的性质" tabindex="-1"><a class="header-anchor" href="#_11、枚举成员的性质" aria-hidden="true">#</a> 11、枚举成员的性质</h3><p>TIP</p><p>枚举成员的值是一个只读类型，因此定义之后是不能修改的。</p><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token comment">// 数字枚举</span>
<span class="token keyword">enum</span> Role <span class="token punctuation">{</span>
  <span class="token comment">// 自定义数字枚举的初始值为 1，默认从0开始</span>
  SuperAdministrator <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">,</span>
  Administrators<span class="token punctuation">,</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://www.arryblog.com/assets/img/image-20230621204613610.1ef487d9.png" alt="image-20230621204613610"></p><h3 id="_12、枚举成员的分类" tabindex="-1"><a class="header-anchor" href="#_12、枚举成员的分类" aria-hidden="true">#</a> 12、枚举成员的分类</h3><p>TIP</p><p>枚举成员的分为两类</p><p><strong>①、<code>const enum</code> 常量枚举，有三种情况</strong></p><ul><li>没有初始值的</li><li>对已有枚举成员的引用</li><li>常量的表达式</li></ul><p><strong>②、<code>computed enum</code> 需要被计算的枚举成员（非常量的表达式）</strong></p><ul><li>这些枚举成员的值不会在编译阶段进行计算，而会被保留到程序执行阶段</li></ul><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token comment">// 枚举成员</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,51),g={href:"https://www.typescriptlang.org/play?#code/PTAEizzQ+OUBCNA0VAoApgOwK4FtQGEAWBDAJ1AG95RzQRQBjAe2QGcAXUFDUQDj1B5xKkBh-wSHNAkHKBZz0CjBoFbFQBD-eXgCNe1QJD-ZCngA0K8rNABebPgIA6dZpq7QARlABqUACYNFSmDroADqiaIAJqzSZAAHTAQMjAaojAQujAdO9AELcoOElAPXTuKMALCMA++MB4fWUnXz0AWTwmHEMCPGRvWnQACgBKRwpEcwByCzsAZkbDABsUAHNC+ABfIA",target:"_blank",rel:"noopener noreferrer"},x=a(`<p><img src="https://www.arryblog.com/assets/img/image-20230621225116041.cfd5e95d.png" alt="image-20230621225116041"></p><p>注：</p><p>通过以编译后的 JS 代码可看到</p><ul><li>常量枚举成员，已经被计算出了结果，分别是 0、0、3</li><li>需要被计算的枚举成员，它的值被保留了，需要在运行时环境才会被计算</li></ul><blockquote><p>如果定义在 computed enum 后边的枚举成员，必须要有一个 初始值，否则会报错</p></blockquote><h3 id="_13、常量枚举" tabindex="-1"><a class="header-anchor" href="#_13、常量枚举" aria-hidden="true">#</a> 13、常量枚举</h3><p>TIP</p><p>用 const 声明的枚举 就是 <strong>常量枚举</strong></p><p>常量枚举的特性：会在编译阶段被移除</p><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token comment">// 常量枚举</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_15、总结" tabindex="-1"><a class="header-anchor" href="#_15、总结" aria-hidden="true">#</a> 15、总结</h3><p>TIP</p><p>关于 TS 的枚举类型，需要我们掌握一种思维方法：将程序中不容易记忆的硬编码 或 在未来中可能改变的常量抽取出来，定义成枚举类型。</p><p>这样可以提高我们程序的可读性 和 可维护性，枚举类型可以使我们的程序以不变应万变。</p><h2 id="二、interface-接口" tabindex="-1"><a class="header-anchor" href="#二、interface-接口" aria-hidden="true">#</a> 二、interface 接口</h2><p>TIP</p><p>接口在 TS 中是一个非常重要的概念，接口可以用来约束对象、函数、以及类的结构 和 类型，这是一种代码协作的契约，我们必须遵守而且不能改变。</p><h3 id="_1、什么是-interface-接口" tabindex="-1"><a class="header-anchor" href="#_1、什么是-interface-接口" aria-hidden="true">#</a> 1、什么是 interface 接口</h3><p>TIP</p><p>interface 是对象的模板，可以看作是一种类型约定，中文译为“接口”。使用了某个模板的对象，就拥有了指定的类型结构。</p><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token keyword">interface</span> <span class="token class-name">User</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2、interface-表示对象的-5-种语法" tabindex="-1"><a class="header-anchor" href="#_2、interface-表示对象的-5-种语法" aria-hidden="true">#</a> 2、interface 表示对象的 5 种语法</h3><p>TIP</p><p>interface 可以表示对象的各种语法，它的成员有 5 种形式。</p><ul><li>对象属性</li><li>对象的属性索引</li><li>对象方法</li><li>函数</li><li>构造函数</li></ul><h3 id="_2-1、对象属性" tabindex="-1"><a class="header-anchor" href="#_2-1、对象属性" aria-hidden="true">#</a> 2.1、对象属性</h3><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token keyword">interface</span> <span class="token class-name">Point</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-3、对象的方法" tabindex="-1"><a class="header-anchor" href="#_2-3、对象的方法" aria-hidden="true">#</a> 2.3、对象的方法</h3><p>TIP</p><p>对象的方法共有三种写法</p><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token comment">// 写法一</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-4、函数" tabindex="-1"><a class="header-anchor" href="#_2-4、函数" aria-hidden="true">#</a> 2.4、函数</h3><p>TIP</p><p>interface 也可以用来声明独立的函数</p><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token keyword">interface</span> <span class="token class-name">Add</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-5、构造函数" tabindex="-1"><a class="header-anchor" href="#_2-5、构造函数" aria-hidden="true">#</a> 2.5、构造函数</h3><p>TIP</p><p>interface 内部可以使用<code>new</code>关键字，表示构造函数。</p><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token keyword">interface</span> <span class="token class-name">ErrorConstructor</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-2、interface-继承-type" tabindex="-1"><a class="header-anchor" href="#_3-2、interface-继承-type" aria-hidden="true">#</a> 3.2、interface 继承 type</h3><p>TIP</p><p>interface 可以继承<code>type</code>命令定义的对象类型。</p><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token keyword">type</span> <span class="token class-name">Person</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
  username<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">;</span>
  age<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4、接口合并" tabindex="-1"><a class="header-anchor" href="#_4、接口合并" aria-hidden="true">#</a> 4、接口合并</h3><p>TIP</p><p>多个同名接口会合并成一个接口。</p><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token keyword">interface</span> <span class="token class-name">Box</span> <span class="token punctuation">{</span>
  height<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5、interface-与-type-的异同" tabindex="-1"><a class="header-anchor" href="#_5、interface-与-type-的异同" aria-hidden="true">#</a> 5、interface 与 type 的异同</h3><p>TIP</p><p><code>interface</code>命令与<code>type</code>命令作用类似，都可以表示对象类型。</p><p>很多对象类型既可以用 interface 表示，也可以用 type 表示。而且，两者往往可以换用，几乎所有的 interface 命令都可以改写为 type 命令。</p><h3 id="_5-1、相似之处" tabindex="-1"><a class="header-anchor" href="#_5-1、相似之处" aria-hidden="true">#</a> 5.1、相似之处</h3><p>TIP</p><p>它们的相似之处，首先表现在都能为对象类型起名。</p><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token keyword">type</span> <span class="token class-name">User</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
  username<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">;</span>
  age<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注：</p><p><code>[x: string]: any;</code> 在 <code>[]</code> 中定义一个 <code>x</code> ，它的返回值类型是 <code>any</code> 这就是一个字符串索引签名。</p><p>它的含义是：用任意的字符串去索引 <code>List</code> 可以得到任意的结果，这样 List 就可以支持多个属性了。</p><h3 id="_8、接口成员-可选属性" tabindex="-1"><a class="header-anchor" href="#_8、接口成员-可选属性" aria-hidden="true">#</a> 8、接口成员 - 可选属性</h3><p>TIP</p><p>需求：判断 value 中是否有新的字段，如果有就打印出来</p><blockquote><p>可选属性语法：在属性前添加一个 <code>?</code> 问号，表示该属性可有可无</p></blockquote><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token keyword">interface</span> <span class="token class-name">List</span> <span class="token punctuation">{</span>
  id<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">;</span>
  username<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">;</span>
  age<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">;</span>
...
<span class="token function">render</span><span class="token punctuation">(</span>result<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://www.arryblog.com/assets/img/image-20230623192623265-16937300444665.f5c2178f.png" alt="image-20230623192623265"></p><h3 id="_9、接口成员-只读属性" tabindex="-1"><a class="header-anchor" href="#_9、接口成员-只读属性" aria-hidden="true">#</a> 9、接口成员 - 只读属性</h3><p>TIP</p><p>只读属性：给一个属性添加 <code>readonly</code> ，一般 id 都是只读的，并且只读属性都是不能修改的。</p><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token keyword">interface</span> <span class="token class-name">List</span> <span class="token punctuation">{</span>
...
<span class="token function">render</span><span class="token punctuation">(</span>result<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://www.arryblog.com/assets/img/image-20230623193912490-16937300444666.f615c095.png" alt="image-20230623193912490"></p><h3 id="_10、可索引类型的接口-数字索引" tabindex="-1"><a class="header-anchor" href="#_10、可索引类型的接口-数字索引" aria-hidden="true">#</a> 10、可索引类型的接口 - 数字索引</h3><p>TIP</p><p>以上接口的属性个数都是固定的，当我们不确定一个接口中有多少个属性时，就可以使用可索引类型的接口。</p><p>可索引类型的接口可使用数字索引，也可用字符串来索引。</p><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token comment">// 定义一个用数字索引的接口</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_12、总结" tabindex="-1"><a class="header-anchor" href="#_12、总结" aria-hidden="true">#</a> 12、总结</h3><p>TIP</p><p>以上学习了对象类型接口，可以将过去我们开发过的 API 或 调用过的 API ，用接口去描述一下。</p><p>在这个过程中，会强制我们去思考一些变量的类型，也会思考一些接口的边界问题。这个过程非常有利于你培养类型思维。</p><h3 id="_13、函数类型接口" tabindex="-1"><a class="header-anchor" href="#_13、函数类型接口" aria-hidden="true">#</a> 13、函数类型接口</h3><p>TIP</p><p>在数据类型中学过，使用变量来定义一个函数类型。如下</p><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token keyword">let</span> <span class="token function-variable function">add</span><span class="token operator">:</span> <span class="token punctuation">(</span>x<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">,</span> y<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token builtin">number</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_14、混合类型接口" tabindex="-1"><a class="header-anchor" href="#_14、混合类型接口" aria-hidden="true">#</a> 14、混合类型接口</h3><p>TIP</p><p>一个接口既可以定义一个函数，也可以像对象一样拥有属性和方法，即：混合类型接口</p><p>使用混合接口定义一个类库</p><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token comment">// 使用混合接口定义一个类库</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>总结：</p><p>以上我们用接口分别定义了对象和函数，其实接口还可以定义类的结构和类型，这部分内容会在学习完 TS 的类之后在做学习。</p>`,235);function A(q,E){const e=o("ExternalLinkIcon");return c(),i("div",null,[u,s("p",null,[n("它是如何实现的 ？ 可在 "),s("a",r,[n("TypeScript - Playground (opens new window)"),p(e)]),n("中编译查看编译后的 JS 代码")]),d,s("p",null,[s("a",k,[n("TypeScript 5.0 (opens new window)"),p(e)]),n("之前，Enum 有一个 Bug，就是 Enum 类型的变量可以赋值为任何数值。")]),v,s("p",null,[n("在 "),s("a",m,[n("TypeScript - Playground (opens new window)"),p(e)]),n("中编译查看编译后的 JS 代码")]),b,s("p",null,[n("在 "),s("a",g,[n("TypeScript - Playground (opens new window)"),p(e)]),n("中编译查看编译后的 JS 代码")]),x,s("p",null,[n("在 "),s("a",y,[n("TypeScript - Playground (opens new window)"),p(e)]),n("中编译查看编译后的 JS 代码，发现编译后没有任何代码")]),h,s("p",null,[n("在 "),s("a",f,[n("TypeScript - Playground (opens new window)"),p(e)]),n("中编译查看编译后的 JS 代码")]),w])}const B=t(l,[["render",A],["__file","TypeScript zhong Enum meijuleixing、interface jiekouleixing.html.vue"]]);export{B as default};
