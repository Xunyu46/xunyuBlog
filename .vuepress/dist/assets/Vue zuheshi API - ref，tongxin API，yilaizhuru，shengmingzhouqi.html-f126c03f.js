import{_ as o,r as p,o as l,c as i,a as n,b as s,e as t,d as e}from"./app-3a073675.js";const c={},u=e('<h1 id="vue-组合式-api-ref-通信-api-依赖注入-生命周期" tabindex="-1"><a class="header-anchor" href="#vue-组合式-api-ref-通信-api-依赖注入-生命周期" aria-hidden="true">#</a> Vue 组合式 API - ref，通信 API，依赖注入，生命周期</h1><p>从本节内容开始，我们正式深入 Vue 组合式 API 的相关部分细节</p><ul><li>模板引用 ref</li><li>组合式 API - 组件通信 API</li><li>props、emits、透传属性、expose</li><li>依赖与注入</li><li>生命周期钩子</li><li>组合式 API 常见疑问</li><li>实战应用：带历史记录的搜索</li></ul>',3),d={id:"一、模板引用",tabindex:"-1"},r=n("a",{class:"header-anchor",href:"#一、模板引用","aria-hidden":"true"},"#",-1),v={href:"https://www.arryblog.com/vip/vue/composition-api-ref-provide-provide-life-cycle.html#%E4%B8%80%E3%80%81%E6%A8%A1%E6%9D%BF%E5%BC%95%E7%94%A8",target:"_blank",rel:"noopener noreferrer"},k=n("p",null,"深入浅出 组合式 API 中 ref 模板引用，v-for 中的模板引用，组件上的 ref 等",-1),m={id:"_1、ref-模板引用",tabindex:"-1"},g=n("a",{class:"header-anchor",href:"#_1、ref-模板引用","aria-hidden":"true"},"#",-1),b={href:"https://www.arryblog.com/vip/vue/composition-api-ref-provide-provide-life-cycle.html#_1%E3%80%81ref-%E6%A8%A1%E6%9D%BF%E5%BC%95%E7%94%A8",target:"_blank",rel:"noopener noreferrer"},h=e(`<p>在组合式 API 中要获得对模板的引用，我们需要声明一个同名的 ref 变量。</p><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">setup</span><span class="token punctuation">&gt;</span></span><span class="token script"><span class="token language-javascript">
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">&gt;</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意</p><p>你只可以<strong>在组件挂载后</strong>才能访问模板引用，在没有挂载前模板引用的 ref 值是一个 null。</p>`,4),f={id:"_2、v-for-中的模板引用",tabindex:"-1"},_=n("a",{class:"header-anchor",href:"#_2、v-for-中的模板引用","aria-hidden":"true"},"#",-1),q={href:"https://www.arryblog.com/vip/vue/composition-api-ref-provide-provide-life-cycle.html#_2%E3%80%81v-for-%E4%B8%AD%E7%9A%84%E6%A8%A1%E6%9D%BF%E5%BC%95%E7%94%A8",target:"_blank",rel:"noopener noreferrer"},E=e(`<p>当在 <code>v-for</code> 中使用模板引用时，对应的 ref 中包含的值是一个数组，它将在元素被挂载后包含对应整个列表的所有元素</p><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">setup</span><span class="token punctuation">&gt;</span></span><span class="token script"><span class="token language-javascript">
  <span class="token keyword">import</span> <span class="token punctuation">{</span> ref<span class="token punctuation">,</span> onMounted <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&quot;vue&quot;</span><span class="token punctuation">;</span>
...
&lt;template&gt;
  &lt;div&gt;{{ msg }}&lt;/div&gt;
&lt;/template&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),B={id:"二、组合式-api-组件通信-api",tabindex:"-1"},I=n("a",{class:"header-anchor",href:"#二、组合式-api-组件通信-api","aria-hidden":"true"},"#",-1),P={href:"https://www.arryblog.com/vip/vue/composition-api-ref-provide-provide-life-cycle.html#%E4%BA%8C%E3%80%81%E7%BB%84%E5%90%88%E5%BC%8F-api-%E7%BB%84%E4%BB%B6%E9%80%9A%E4%BF%A1-api",target:"_blank",rel:"noopener noreferrer"},C=e("<p>本小节主要讲解组合式 API 中涉及组件间通信的 API，具体有：</p><ul><li><code>defineProps()</code>方法，用来声明接受的 props</li><li><code>defineEmits()</code>方法，用来声明接受的事件监听</li><li><code>useAttrs()</code>方法，用来接受所有的透传属性</li><li><code>defineOptions()</code>方法，用来在组合式 API 中声明组件选项</li><li><code>defineExpose()</code>方法，用来对外暴露组件的属性和方法</li></ul>",2),M={id:"_1、defineprops",tabindex:"-1"},j=n("a",{class:"header-anchor",href:"#_1、defineprops","aria-hidden":"true"},"#",-1),F={href:"https://www.arryblog.com/vip/vue/composition-api-ref-provide-provide-life-cycle.html#_1%E3%80%81defineprops",target:"_blank",rel:"noopener noreferrer"},D=e(`<ul><li>在选项式 API 中，通过 props 选项来声明父组件传递的 props</li><li>在组合式 API 中，通过<code>defineProps()</code>方法来声明 props。</li><li><code>defineProps()</code>方法接收与 <code>props</code> 选项相同的值</li></ul><blockquote><p><code>defineProps()</code>方法被称为编译器宏，在组合式 API 中不需要导入，可以直接使用</p></blockquote><ul><li>数组简写形式</li></ul><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">setup</span><span class="token punctuation">&gt;</span></span><span class="token script"><span class="token language-javascript">
...
&lt;/template&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>以上代码最终渲染效果如下：</p></blockquote><p><img src="https://www.arryblog.com/assets/img/GIF2023-5-1918-15-02.b6427b47.gif" alt="GIF2023-5-1918-15-02"></p><p>注：</p><p>在打开页面 2 秒后，生命周期函数中的<code>emit(&quot;addEvent&quot;)</code>方法触发了自定事件 addEvent，执行了<code>count.value++</code>，count 的值从 0 变成了 1。</p><p>后面点击 count++按扭，多次触发自定义事件 addEvent，则 count 不断加 1</p>`,10),S={id:"_3、useattrs-方法",tabindex:"-1"},$=n("a",{class:"header-anchor",href:"#_3、useattrs-方法","aria-hidden":"true"},"#",-1),G={href:"https://www.arryblog.com/vip/vue/composition-api-ref-provide-provide-life-cycle.html#_3%E3%80%81useattrs-%E6%96%B9%E6%B3%95",target:"_blank",rel:"noopener noreferrer"},z=e(`<p>在选项式 API 中，可以通过<code>this.$attrs</code>来访问透传属性。</p><p>在组合式 API 中，我们需要用 Vue 提供的<code>useAttrs()</code>方法来获取所有透传属性，该方法的返回值与选项式 API 中<code>this.$attrs</code>的值是一样的</p><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token comment">&lt;!--父组件中调用Count--&gt;</span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>注：</p><p><code>class</code>与<code>id</code>属性并没有自动透传绑定 div 元素身上</p>`,13),H={id:"_4、defineoptions-方法",tabindex:"-1"},J=n("a",{class:"header-anchor",href:"#_4、defineoptions-方法","aria-hidden":"true"},"#",-1),L={href:"https://www.arryblog.com/vip/vue/composition-api-ref-provide-provide-life-cycle.html#_4%E3%80%81defineoptions-%E6%96%B9%E6%B3%95",target:"_blank",rel:"noopener noreferrer"},T=e(`<p>在 <strong>Vue3.3+</strong> 以上版本，defineOptions 这个宏可以用来直接在 <code>&lt;script setup&gt;</code> 中声明组件选项，而不必使用单独的 <code>&lt;script&gt;</code> 块</p><blockquote><p><code>defineOptions()</code>方法被称为编译器宏，在组合式 API 中不需要导入，可以直接使用</p></blockquote><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token comment">&lt;!--父组件中调用Count--&gt;</span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>Count</span> <span class="token attr-name">:class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>[&#39;active&#39;]<span class="token punctuation">&quot;</span></span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>box<span class="token punctuation">&quot;</span></span> <span class="token punctuation">/&gt;</span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>属性自动透传行为被禁止，<code>msg</code>被正确的在模板中解析出来了</p></blockquote>`,6),R={id:"_5、defineexpose-方法",tabindex:"-1"},K=n("a",{class:"header-anchor",href:"#_5、defineexpose-方法","aria-hidden":"true"},"#",-1),Q={href:"https://www.arryblog.com/vip/vue/composition-api-ref-provide-provide-life-cycle.html#_5%E3%80%81defineexpose-%E6%96%B9%E6%B3%95",target:"_blank",rel:"noopener noreferrer"},W=e(`<p>使用 <code>&lt;script setup&gt;</code> 的组件是<strong>默认关闭</strong>的——即通过模板引用或者 <code>$parent</code> 链获取到的组件的公开实例，<strong>不会</strong>暴露任何在 <code>&lt;script setup&gt;</code> 中声明的绑定。</p><p>可以通过 <code>defineExpose</code> 编译器宏来显式指定在 <code>&lt;script setup&gt;</code> 组件中要暴露出去的属性</p><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">setup</span><span class="token punctuation">&gt;</span></span><span class="token script"><span class="token language-javascript">
...
&lt;template&gt;
  ...
  &lt;div&gt;{{ num}}&lt;/div&gt;
&lt;/template&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>以上代码，渲染后在控制台输出如下内容</p></blockquote><p><img src="https://www.arryblog.com/assets/img/image-20230519202930499.2a83c5a4.png" alt="image-20230519202930499"></p>`,7),X={id:"三、依赖与注入",tabindex:"-1"},Y=n("a",{class:"header-anchor",href:"#三、依赖与注入","aria-hidden":"true"},"#",-1),Z={href:"https://www.arryblog.com/vip/vue/composition-api-ref-provide-provide-life-cycle.html#%E4%B8%89%E3%80%81%E4%BE%9D%E8%B5%96%E4%B8%8E%E6%B3%A8%E5%85%A5",target:"_blank",rel:"noopener noreferrer"},nn=n("p",null,"在组合式 API 中，组件要为后代组件提供数据，后代组件要能使用上层组件提供的数据，需要经过以下两步：",-1),sn=n("ul",null,[n("li",null,[s("上层组件通过"),n("code",null,"provide()"),s("函数向后代组件提供数据")]),n("li",null,[s("后代组件通过"),n("code",null,"inject()"),s("函数注入上层组件提供的数据")])],-1),an={id:"_1、provide-函数",tabindex:"-1"},tn=n("a",{class:"header-anchor",href:"#_1、provide-函数","aria-hidden":"true"},"#",-1),en={href:"https://www.arryblog.com/vip/vue/composition-api-ref-provide-provide-life-cycle.html#_1%E3%80%81provide-%E5%87%BD%E6%95%B0",target:"_blank",rel:"noopener noreferrer"},on=e(`<p><code>provide()</code>函数用于在组合式 API 中为后代组件提供数据</p><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">setup</span><span class="token punctuation">&gt;</span></span><span class="token script"><span class="token language-javascript">
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>参数详解</p><ul><li>第一个参数为注入名，可以是一个字符串或一个 Symbol 类型，后代组件会用该注入名来查找期望的注入值</li><li>第二个参数是提供的值，值可以是任意类型，如果值是一个响应式的（如比 ref 或 reactive），则后代组件可以由此和提供者建立响应式的联系。</li></ul><blockquote><p>一个组件可以多次调用 <code>provide()</code>，使用不同的注入名，注入不同的依赖值。</p></blockquote>`,5),pn={id:"_2、inject-函数",tabindex:"-1"},ln=n("a",{class:"header-anchor",href:"#_2、inject-函数","aria-hidden":"true"},"#",-1),cn={href:"https://www.arryblog.com/vip/vue/composition-api-ref-provide-provide-life-cycle.html#_2%E3%80%81inject-%E5%87%BD%E6%95%B0",target:"_blank",rel:"noopener noreferrer"},un=e(`<p><code>inject()</code>函数用于在组合式 API 中，后代组件要注入上层组件提供的数据</p><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">setup</span><span class="token punctuation">&gt;</span></span><span class="token script"><span class="token language-javascript">
...
&lt;template&gt;
  ...
  &lt;div&gt;爱好：{{ hobbies }}&lt;/div&gt;
&lt;/template&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>以上代码最终渲染效果如下：</p></blockquote><p><img src="https://www.arryblog.com/assets/img/GIF2023-5-1922-19-11.5e6118f2.gif" alt="GIF2023-5-1922-19-11"></p>`,9),dn={id:"四、生命周期钩子",tabindex:"-1"},rn=n("a",{class:"header-anchor",href:"#四、生命周期钩子","aria-hidden":"true"},"#",-1),vn={href:"https://www.arryblog.com/vip/vue/composition-api-ref-provide-provide-life-cycle.html#%E5%9B%9B%E3%80%81%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F%E9%92%A9%E5%AD%90",target:"_blank",rel:"noopener noreferrer"},kn=n("p",null,"深入浅出 Vue 组合式 API 中的生命周期钩子，生命周期函数示图，生命周期函数使用 等。",-1),mn={id:"_1、生命周期函数示图",tabindex:"-1"},gn=n("a",{class:"header-anchor",href:"#_1、生命周期函数示图","aria-hidden":"true"},"#",-1),bn={href:"https://www.arryblog.com/vip/vue/composition-api-ref-provide-provide-life-cycle.html#_1%E3%80%81%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F%E5%87%BD%E6%95%B0%E7%A4%BA%E5%9B%BE",target:"_blank",rel:"noopener noreferrer"},hn=e('<blockquote><p>我们再来回顾之前讲到的生命周期函数示图</p></blockquote><p><img src="https://www.arryblog.com/assets/img/lifecycle.16e4c08e.1ae3c5f4.png" alt="lifecycle.16e4c08e"></p><p>注：</p><p>组合式 API 中的生命周期函数与选项式 API 中是几乎是一一对应的，只是存在以下两点不同：</p><ul><li>两者函数名写法上有所不同，组合式 API 生命周函数都以 on 开头，并采用驼峰命名，如下表。</li><li>组合式 API 中没有与之对应的<code>onBeforeCreate</code>与<code>onCreated</code>函数，所有期望在<code>beforeCreate</code>与<code>created</code>生命周期函数阶段执行的代码都可以写在在<code>setup()</code>函数或<code>&lt;script setup&gt;</code>标签中。</li></ul><p>因为<code>setup()</code>与<code>&lt;script setup&gt;</code>中的代码会在<code>beforeCreate</code>生命周期函数之前被处理。相当于组合式 API 中所有写在<code>setup()</code>函数或<code>&lt;script setup&gt;</code>中的顶层变量或方法相当于选项式 API 中<code>data()</code>方法与<code>methods</code>选项等其它选项对外暴露的属性和方法。</p><p><strong>组合式 API 与选项式 API 中生命周期函数的对比表</strong></p><table><thead><tr><th style="text-align:left;">选项式 API</th><th style="text-align:left;">组合式 API</th><th style="text-align:left;">说明</th></tr></thead><tbody><tr><td style="text-align:left;">beforeCreate</td><td style="text-align:left;">setup</td><td style="text-align:left;">在组件实例初始化完成之后立即调用</td></tr><tr><td style="text-align:left;">created</td><td style="text-align:left;">setup</td><td style="text-align:left;">在组件实例处理完所有与状态相关的选项后调用。</td></tr><tr><td style="text-align:left;">beforeMount</td><td style="text-align:left;">onBeforeMount</td><td style="text-align:left;">组件被挂载之前被调</td></tr><tr><td style="text-align:left;">mounted</td><td style="text-align:left;">onMounted</td><td style="text-align:left;">用组件挂载完成后执行</td></tr><tr><td style="text-align:left;">beforeUpdate</td><td style="text-align:left;">onBeforeUpdate</td><td style="text-align:left;">组件即将因为响应式状态变更而更新其 DOM 树之前调用</td></tr><tr><td style="text-align:left;">updated</td><td style="text-align:left;">onUpdated</td><td style="text-align:left;">组件因为响应式状态变更而更新其 DOM 树之后调用</td></tr><tr><td style="text-align:left;">beforeUnmount</td><td style="text-align:left;">onBeforeUnmount</td><td style="text-align:left;">组件实例被卸载之前调用</td></tr><tr><td style="text-align:left;">unmounted</td><td style="text-align:left;">onUnmounted</td><td style="text-align:left;">组件实例被卸载之后调用</td></tr></tbody></table>',8),fn={id:"_2、生命周期函数使用",tabindex:"-1"},_n=n("a",{class:"header-anchor",href:"#_2、生命周期函数使用","aria-hidden":"true"},"#",-1),qn={href:"https://www.arryblog.com/vip/vue/composition-api-ref-provide-provide-life-cycle.html#_2%E3%80%81%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F%E5%87%BD%E6%95%B0%E4%BD%BF%E7%94%A8",target:"_blank",rel:"noopener noreferrer"},En=e(`<ul><li>组合式 API 中生命周期函数需要先导入，然后才能使用。</li><li>每个生命周期函数的第一个参数是一个回调函数，在组件或应用执行到此阶段时，会触发该回调函数。</li></ul><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">setup</span><span class="token punctuation">&gt;</span></span><span class="token script"><span class="token language-javascript">
...
&lt;template&gt;
  ...
  &lt;div&gt;{{ count }}&lt;/div&gt;
&lt;/template&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>以上代码最终渲染后效果如下：</p></blockquote><p><img src="https://www.arryblog.com/assets/img/GIF2023-5-1923-28-52.df8c1a9e.gif" alt="GIF2023-5-1923-28-52"></p>`,9),yn={id:"五、组合式-api-常见疑问",tabindex:"-1"},xn=n("a",{class:"header-anchor",href:"#五、组合式-api-常见疑问","aria-hidden":"true"},"#",-1),An={href:"https://www.arryblog.com/vip/vue/composition-api-ref-provide-provide-life-cycle.html#%E4%BA%94%E3%80%81%E7%BB%84%E5%90%88%E5%BC%8F-api-%E5%B8%B8%E8%A7%81%E7%96%91%E9%97%AE",target:"_blank",rel:"noopener noreferrer"},wn={href:"https://cn.vuejs.org/guide/extras/composition-api-faq.html",target:"_blank",rel:"noopener noreferrer"},Bn={id:"六、实战应用-带历史记录的搜索",tabindex:"-1"},In=n("a",{class:"header-anchor",href:"#六、实战应用-带历史记录的搜索","aria-hidden":"true"},"#",-1),Pn={href:"https://www.arryblog.com/vip/vue/composition-api-ref-provide-provide-life-cycle.html#%E5%85%AD%E3%80%81%E5%AE%9E%E6%88%98%E5%BA%94%E7%94%A8-%E5%B8%A6%E5%8E%86%E5%8F%B2%E8%AE%B0%E5%BD%95%E7%9A%84%E6%90%9C%E7%B4%A2",target:"_blank",rel:"noopener noreferrer"},Cn=n("p",null,"本小节我们一起来完成《带历史记录的搜索》案例",-1),Mn=n("blockquote",null,[n("p",null,"具体效果如下：")],-1),jn=n("p",null,[n("img",{src:"https://www.arryblog.com/assets/img/GIF2023-7-1418-47-54.02cd61b0.gif",alt:"GIF2023-7-1418-47-54"})],-1),Fn={id:"_1、项目功能介绍",tabindex:"-1"},Dn=n("a",{class:"header-anchor",href:"#_1、项目功能介绍","aria-hidden":"true"},"#",-1),Un={href:"https://www.arryblog.com/vip/vue/composition-api-ref-provide-provide-life-cycle.html#_1%E3%80%81%E9%A1%B9%E7%9B%AE%E5%8A%9F%E8%83%BD%E4%BB%8B%E7%BB%8D",target:"_blank",rel:"noopener noreferrer"},Nn=n("blockquote",null,[n("p",null,"首先我们来了解下，该案例所需要实现的功能点：")],-1),Vn=n("ul",null,[n("li",null,[s("在搜索框中输入内容，并按回车键 "),n("ul",null,[n("li",null,"输入框中的内容添加到搜索历史列表中"),n("li",null,"根据关键词搜索对应的课程，并且将搜索的结果以列表形式呈现在页面中")])]),n("li",null,"点击搜索框右则的取消按扭，可以取消输入框中的的内容"),n("li",null,"点击搜索历史列表中的关键字，可以触发搜索功能，将搜索的结果以列表形式呈现在页面中"),n("li",null,"点击搜索历史列表右则的删除按扭，可以清空搜索历史列表。")],-1),On={id:"_2、项目涉及核心知识点",tabindex:"-1"},Sn=n("a",{class:"header-anchor",href:"#_2、项目涉及核心知识点","aria-hidden":"true"},"#",-1),$n={href:"https://www.arryblog.com/vip/vue/composition-api-ref-provide-provide-life-cycle.html#_2%E3%80%81%E9%A1%B9%E7%9B%AE%E6%B6%89%E5%8F%8A%E6%A0%B8%E5%BF%83%E7%9F%A5%E8%AF%86%E7%82%B9",target:"_blank",rel:"noopener noreferrer"},Gn=e('<blockquote><p>该项目所涉及知识点较多，主要有：</p></blockquote><table><thead><tr><th style="text-align:left;">知识点分类</th><th style="text-align:left;">涉及内容</th></tr></thead><tbody><tr><td style="text-align:left;">Vue 基础（组合式）</td><td style="text-align:left;">插值语法、列表渲染、v-bind 指令、表单元素绑定、事件绑定、样式绑定、事件修饰符 、watchEffect 侦听器、响应式 API-reactive</td></tr><tr><td style="text-align:left;">组件间通信</td><td style="text-align:left;">defineProps、defineEmits、组件 v-model</td></tr><tr><td style="text-align:left;">原生 JS 基础</td><td style="text-align:left;">本地数据持久化： localStorage 本地存储、JSON.parse、JSON.stringify 数组相关 API：unshift</td></tr><tr><td style="text-align:left;">网络请求</td><td style="text-align:left;">axios</td></tr></tbody></table>',2),zn={id:"_3、学习目标",tabindex:"-1"},Hn=n("a",{class:"header-anchor",href:"#_3、学习目标","aria-hidden":"true"},"#",-1),Jn={href:"https://www.arryblog.com/vip/vue/composition-api-ref-provide-provide-life-cycle.html#_3%E3%80%81%E5%AD%A6%E4%B9%A0%E7%9B%AE%E6%A0%87",target:"_blank",rel:"noopener noreferrer"},Ln=n("blockquote",null,[n("p",null,"通过该案例的学习，我们将重点掌握以下内容")],-1),Tn=n("ul",null,[n("li",null,"项目开发流程：如何一步步完成项目的开发，先做什么后做什么"),n("li",null,"组件拆分：一个完整的项目，应该如何进行组件化拆分"),n("li",null,"组件功能分析：分析拆分出来的组件具有那些功能，需要那些 props、事件、插槽等"),n("li",null,"组件间通信：在实际开发中，组件间通信时应该选择那一种通信方式最合适")],-1);function Rn(Kn,Qn){const a=p("ExternalLinkIcon");return l(),i("div",null,[u,n("h2",d,[r,s(),n("a",v,[s("#"),t(a)]),s("一、模板引用")]),k,n("h3",m,[g,s(),n("a",b,[s("#"),t(a)]),s("1、ref 模板引用")]),h,n("h3",f,[_,s(),n("a",q,[s("#"),t(a)]),s("2、v-for 中的模板引用")]),E,n("h3",y,[x,s(),n("a",A,[s("#"),t(a)]),s("3、组件上的 ref")]),w,n("h2",B,[I,s(),n("a",P,[s("#"),t(a)]),s("二、组合式 API - 组件通信 API")]),C,n("h3",M,[j,s(),n("a",F,[s("#"),t(a)]),s("1、defineProps()")]),D,n("h3",U,[N,s(),n("a",V,[s("#"),t(a)]),s("2、defineEmits() 方法")]),O,n("h3",S,[$,s(),n("a",G,[s("#"),t(a)]),s("3、useAttrs() 方法")]),z,n("h3",H,[J,s(),n("a",L,[s("#"),t(a)]),s("4、defineOptions() 方法")]),T,n("h3",R,[K,s(),n("a",Q,[s("#"),t(a)]),s("5、defineExpose() 方法")]),W,n("h2",X,[Y,s(),n("a",Z,[s("#"),t(a)]),s("三、依赖与注入")]),nn,sn,n("h3",an,[tn,s(),n("a",en,[s("#"),t(a)]),s("1、provide() 函数")]),on,n("h3",pn,[ln,s(),n("a",cn,[s("#"),t(a)]),s("2、inject() 函数")]),un,n("h2",dn,[rn,s(),n("a",vn,[s("#"),t(a)]),s("四、生命周期钩子")]),kn,n("h3",mn,[gn,s(),n("a",bn,[s("#"),t(a)]),s("1、生命周期函数示图")]),hn,n("h3",fn,[_n,s(),n("a",qn,[s("#"),t(a)]),s("2、生命周期函数使用")]),En,n("h2",yn,[xn,s(),n("a",An,[s("#"),t(a)]),s("五、组合式 API 常见疑问")]),n("p",null,[s("组合式 API 的常见疑问，大家可以参 Vue 官方文档："),n("a",wn,[s("组合式 API 常见问题(opens new window)"),t(a)])]),n("h2",Bn,[In,s(),n("a",Pn,[s("#"),t(a)]),s("六、实战应用：带历史记录的搜索")]),Cn,Mn,jn,n("h3",Fn,[Dn,s(),n("a",Un,[s("#"),t(a)]),s("1、项目功能介绍")]),Nn,Vn,n("h3",On,[Sn,s(),n("a",$n,[s("#"),t(a)]),s("2、项目涉及核心知识点")]),Gn,n("h3",zn,[Hn,s(),n("a",Jn,[s("#"),t(a)]),s("3、学习目标")]),Ln,Tn])}const Xn=o(c,[["render",Rn],["__file","Vue zuheshi API - ref，tongxin API，yilaizhuru，shengmingzhouqi.html.vue"]]);export{Xn as default};
