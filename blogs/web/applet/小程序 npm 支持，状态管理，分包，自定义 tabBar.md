...
<view class="container">
  ...
  <button type="primary" bind:tap="handlerBtn" data-step="{{ 2 }}">
    numA + 2
  </button>

  <button type="primary" bind:tap="handlerBtn" data-step="{{ -1 }}">
    numA - 1
  </button>
</view>
```
...
<button type="warn" bind:tap="handlerBtnB" data-step="{{ -1 }}">
  numB - 1
</button>
```
