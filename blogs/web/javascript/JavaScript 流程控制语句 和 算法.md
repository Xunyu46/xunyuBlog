...
| 语句     | 描述                                                                                                                                                  |
| :------- | :---------------------------------------------------------------------------------------------------------------------------------------------------- |
| break    | break语句用于立即**退出当前循环**，他只能用在循环语句中，如for循环和while循环中都可以                                                                 |
| continue | continue 用于**跳过循环中的一个迭代** ，并继续执行循环中的下一个迭代                                                                                  |
| label    | 与break配合：表示立即退出到label标签标识后的for循环，不再执行 与continue配合：表示退出到label标记位置，继续从label标签标识的for循环开始执行下一次循环 |
