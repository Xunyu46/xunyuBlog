...
![GIF2023-5-2416-44-58](https://www.arryblog.com/assets/img/GIF2023-5-2416-44-58.597a0e3f.gif)
...
![transition-classes.f0f7b3c9](https://www.arryblog.com/assets/img/transition-classes.f0f7b3c9.e5faa8cc.png)
...
![GIF2023-5-2416-46-24](https://www.arryblog.com/assets/img/GIF2023-5-2416-46-24.ea5869bb.gif)
...
![GIF2023-5-2413-54-07](https://www.arryblog.com/assets/img/GIF2023-5-2413-54-07.0e13f1d1.gif)
...
![GIF2023-5-2414-24-10](https://www.arryblog.com/assets/img/GIF2023-5-2414-24-10.ec56d7bd.gif)
...
![GIF2023-5-2414-56-14](https://www.arryblog.com/assets/img/GIF2023-5-2414-56-14.ebd25dce.gif)
...
![GIF2023-5-2421-32-06](https://www.arryblog.com/assets/img/GIF2023-5-2421-32-06.e56b019b.gif)
...
![GIF2023-7-2217-16-01](https://www.arryblog.com/assets/img/GIF2023-7-2217-16-01.fb8bd2df.gif)
...
![GIF2023-5-2418-36-25](https://www.arryblog.com/assets/img/GIF2023-5-2418-36-25.387988e5.gif)
...
![image-20230524185011888](https://www.arryblog.com/assets/img/image-20230524185011888.9f8f9d5b.png)
...
![GIF2023-5-2419-22-48](https://www.arryblog.com/assets/img/GIF2023-5-2419-22-48.32cef275.gif)
...
![GIF2023-5-2421-43-03](https://www.arryblog.com/assets/img/GIF2023-5-2421-43-03.501ae184.gif)
...
![GIF2023-7-2516-28-26](https://www.arryblog.com/assets/img/GIF2023-7-2516-28-26-16902737345943.adc7fcf7.gif)
...
![GIF2023-7-2515-23-19](https://www.arryblog.com/assets/img/GIF2023-7-2515-23-19.6eb8383e.gif)

> 每一轮动画过程中触发的钩子函数，如下图：

![image-20230725152929927](https://www.arryblog.com/assets/img/image-20230725152929927.d577feab.png)
...
![GIF2023-7-2516-28-26](https://www.arryblog.com/assets/img/GIF2023-7-2516-28-26.adc7fcf7.gif)
...
![GIF2023-5-2518-23-39](https://www.arryblog.com/assets/img/GIF2023-5-2518-23-39.8ee372fd.gif)
...
![GIF 2023-7-2419-12-21](https://www.arryblog.com/assets/img/GIF-2023-7-2419-12-21.fe032cdb.gif)
...
index.js // 存放存放的Message组件实例 const messageArr = reactive([]); function
showMessage(app, duration) { // 组件实例 const vm = app.mount(fragment); //
将vm组件实例添加到数组中 messageArr.push(vm);
document.body.appendChild(fragment); // 设置top值 setTop(vm); //
创建侦听器，只要messageArr中的成员有变化，就需要重新设置top的值
watch(messageArr, () => { setTop(vm); }); } // 设置提示框与顶部的距离 function
setTop(vm) { // 设置message显示的top值 const index = messageArr.findIndex((item)
=> item === vm); console.log(messageArr); const top = 20 + index * 60;
vm.setTop(top); } // 当vm卸载时，要从数组中移除 //
移除应用实例（在移除前要先触发动画） function hideMessage(app, vm, duration) {
vm.timer = setTimeout(async () => { await vm.setShow(false); // 从数组中移除vm
--------- const index = messageArr.findIndex((item) => item === vm);
messageArr.splice(index, 1); // 卸载 app.unmount(); clearTimeout(vm.timer);
...
![GIF2023-5-2521-22-07](https://www.arryblog.com/assets/img/GIF2023-5-2521-22-07-16902786516365.f8602d4d.gif)
...
![GIF2023-5-2521-22-07](https://www.arryblog.com/assets/img/GIF2023-5-2521-22-07-16904777055381.f8602d4d.gif)
...
![GIF2023-5-2521-43-17](https://www.arryblog.com/assets/img/GIF2023-5-2521-43-17-16904777055383.c7e38ce2.gif)
...
![GIF2023-5-2521-19-49](https://www.arryblog.com/assets/img/GIF2023-5-2521-19-49-16904777055382.f484f723.gif)
...
![GIF2023-5-2522-10-21](https://www.arryblog.com/assets/img/GIF2023-5-2522-10-21-16904777055384.48782c6b.gif)
...
![GIF2023-5-2522-21-03](https://www.arryblog.com/assets/img/GIF2023-5-2522-21-03-16904777055385.2276ee92.gif)

![GIF2023-5-2522-16-20](https://www.arryblog.com/assets/img/GIF2023-5-2522-16-20-16904777055386.e2bbc04a.gif)
...
![GIF2023-5-2522-41-32](https://www.arryblog.com/assets/img/GIF2023-5-2522-41-32-16904777055397.9bc42707.gif)
...
![GIF2023-7-2523-07-31](https://www.arryblog.com/assets/img/GIF2023-7-2523-07-31.db80675e.gif)
